...
#作業目標網址: https://www.ptt.cc/bbs/Tech_Job/M.1578711060.A.0B0.html
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTT' #爬蟲 ID，在整個 project 中必須要是唯一值
    allowed_domains = ['www.ptt.cc']
    start_urls = ['https://www.ptt.cc/bbs/Tech_Job/M.1578711060.A.0B0.html']
    cookies = {'over18': '1'} #避開「是否滿 18」的頁面，透過 cookies 解決
    #scrapy 在背後會呼叫「start_requests」進行爬蟲，start_requests」為傳送請求
